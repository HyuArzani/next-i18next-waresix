  ...
  wrappedMethods.forEach(function (method) {
    Router[method] = function (path, as, options) {
      ...
      if ((0, _utils.subpathIsRequired)(config, i18n.languages[0])) {
        var fixerFunc = typeof as !== 'undefined' ? _utils.lngPathCorrector : _utils.lngPathCorrectorIgnoreAs;

        var _fixerFunc = fixerFunc(config, {
          as: as,
          href: path
        }, i18n.languages[0]),
            correctedAs = _fixerFunc.as,
            correctedHref = _fixerFunc.href;
